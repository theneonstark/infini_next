                ...
                <CardContent className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">hello@modernservices.com</p>
                      <p className="text-gray-600">support@modernservices.com</p>
                    </div>
                  </div>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Yes! We provide ongoing maintenance and support packages to keep your digital assets running
                    smoothly and up-to-date.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">What's your payment structure?</h4>
                  <p className="text-gray-600 text-sm">
                    We typically work with a 50% upfront payment and 50% upon completion. For larger projects, we can
