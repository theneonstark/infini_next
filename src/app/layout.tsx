  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="description" content="Custom web development, mobile apps, UI/UX, SEO, branding & startup solutions. Infinimorph offers all-in-one digital services in India." />
