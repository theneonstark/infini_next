    ...
    <div className="container relative">
      ...
      <div className="inline-flex relative">
        <AnimatedGradientText>
          <h1 className={cn(
                      `text-6xl sm:text-9xl font-bold tracking-tightner text-center inline-flex animate-gradient bg-gradient-to-r from-[#ffaa40] via-[#9c40ff] to-[#ffaa40] bg-[length:var(--bg-size)_100%] bg-clip-text text-transparent`,
